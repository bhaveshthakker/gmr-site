<div class="row">
	...
	<div class="span8">
		...
		<!-- <section class="top-buffer">
			<legend> <span class="order-bullet">3.</span> Update your personal information</legend>
			<?php //include('update_professional_info_form.php'); ?>
		</section> -->
		<section class="top-buffer"><legend> <span class="order-bullet">3.</span> Update your preferences</legend>
